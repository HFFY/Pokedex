...
import bo.upb.programacion3.codelabpokedex.adapter.PokemonListViewAdapter;
...
public class PokemonListActivity extends AppCompatActivity {
    ...
    static List<Pokemon> pokemonFavList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PokemonListViewAdapter adapter = new PokemonListViewAdapter(this, pokemonFavList);
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Pokemon pokemon = pokemonFavList.get(position);
